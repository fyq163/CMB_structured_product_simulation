...
std::vector<double> two_way_shark_fin(
        ...
        double high_price_trigger,// upper barrier，超过敲出
...
PYBIND11_MODULE(cmb_structured_valuation, m) {
    m.doc() = "module for cmb product valuation"; // Optional module docstring
